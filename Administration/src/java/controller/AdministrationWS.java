...
public class AdministrationWS {
    ...
    public ArrayList<Agreement> listAgreementByStudent(@WebParam(name = "idStudent") 
            String idStudent) {
        DB db = new DB();
    ...
    */
    ...
    public ArrayList<PendingInternship> listPendingInternshipByStudent(@WebParam(name = "idStudent") 
            String idStudent){
        DB db = new DB();
    ...
    public void createPendingInternship(@WebParam(name = "student") String student, 
        ...
        db.createPendingInternship(company, company, postDate,
                salary, description, tutor, phoneNumber, department, location);
        db.closeConnection();
    }
    ...
    public boolean generateAgreement(@WebParam(name = "idEtud") String idEtud, 
                  @WebParam(name = "idInternship") String idInternship) {
        DB db = new DB();
        boolean res = db.generateAgreement(idEtud, idInternship);
        db.closeConnection();
        return res;
    }
