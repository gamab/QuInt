                                            ...
                                            <div class="panel-body">
                                                <div class="dataTable_wrapper">
                                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="candidat" items="${candidats}" varStatus="loop">
                                                            <tr>
                                                                <td><a href="${candidat.nameUrl}" >${candidat.name}</a></td>
                                                                <td><a href="${candidat.schoolUrl}" >${candidat.school}</a></td>
                                                                <td>${candidat.department}</td>
                                                                <td><a href="${candidat.applicationUrl}">${candidat.applicationTitle}</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                        </tbody>
                                                    </table>
