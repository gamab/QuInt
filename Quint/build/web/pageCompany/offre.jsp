<%-- 
    Document   : offre
    Created on : 12/09/2015, 10:33:16 AM
    Author     : Gueldir
--%>
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTable_wrapper">
                                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                    ...
                                                    <tbody>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp" >Stage Développement JAVA/J2EE</a></td>
                                                            <td><a href="description.jsp">4</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>06/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp">Stage Cloud Computing</a></td>
                                                            <td><a href="description.jsp">4</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>08/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp">Stage Développement JAVA/Android</a></td>
                                                            <td><a href="#">0</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>06/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp">Stage Développement C++</a></td>
                                                            <td><a href="#">0</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>09/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="#">Stage Consultant Big Data</a></td>
                                                            <td><a href="#">0</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>04/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp">Stage Smart Grid</a></td>
                                                            <td><a href="#">1</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>01/12/2015</td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="description.jsp">Stage Gestion de VM pour l'Automatisation de Calcul</a></td>
                                                            <td><a href="#">0</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td>21/11/2015</td>
                                                        </tr>
                                                ...
                                                <a href="rediger.jsp" ><button type="button" class="btn btn-primary col-md-2">Ajouter</button></a>
                                            </div>
                                        </div>
                                        <!-- /.panel-body -->
                                    </div>
