<%-- 
    ...
    Created on : 12/09/2015, 03:52:20 PM
    Author     : Gueldir
--%>
...
<head>
    ...
    <title>QuInt - Candidatures</title>
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTable_wrapper">
                                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                    ...
                                                    <tbody>
                                                        <tr class="odd gradeX">
                                                            <td><a href="personne.jsp" >Gabriel Mabille</a></td>
                                                            <td><a href="ecole.jsp" >INSA de Toulouse</a></td>
                                                            <td>Informatique/Réseaux</td>
                                                            <td><a href="description.jsp">Stage Cloud Computing</a></td>
                                                        </tr>
                                                        <tr class="odd gradeX">
                                                            <td><a href="personne.jsp" >Alexandre Demeyer</a></td>
                                                            <td><a href="ecole.jsp" >ENSEIIHT</a></td>
                                                            <td>Sécurité</td>
