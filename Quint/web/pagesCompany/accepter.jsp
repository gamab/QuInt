    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Traiter une candidature</h1>
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form">
                                    <p>Vous avez accepté la candidature de ce candidat. Vous pouvez suivre ici la progression de la procédure.</p>
                                    <div class="form-group">

                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                Sélectionnez l'état de votre progression
                                        </div>
                                        <label class="radio-inline">
                                            <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" checked="">En attente de convention
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2" value="option2">Convention reçu
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline3" value="option3">Convention signée
                                        </label>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <a role="button" class="btn btn-outline btn-primary btn-sm">Télécharger la convention</button></a>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            Importer la convention signée
                                    </div>
                                    <input type="file">
                                </form>
                            </div>
